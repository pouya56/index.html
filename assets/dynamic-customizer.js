/* === Bundled: 3D mug engine (was assets/dynamic-mug-3d.js) === */
/* ==========================================================================
...
(function (root) {
  ...
  function mountMug3D() {
    ...
    opts.onReady = function (viewer) {
      ...
      // Engine is live — remove the flat editor; the mug is the whole experience.
  ...
  // 3D-only mode: swap the upload pill for the design sliders once a design
  // exists, and mirror the slider positions from the design layer.
